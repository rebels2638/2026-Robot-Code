package frc.robot.constants.kicker.proto;

import frc.robot.constants.kicker.KickerConfigBase;

public class KickerConfigProto extends KickerConfigBase {

    public static KickerConfigProto instance = null;
    public static KickerConfigProto getInstance() {
        if (instance == null) {
            instance = new KickerConfigProto();
        }
        return instance;
    }

    private KickerConfigProto() {}
